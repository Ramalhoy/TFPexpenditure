...
jud <- plm(log(Índice) ~ log(despjud) + educ + log (L) + log(K) + log(IMPORT) + log(agua) + log(energiapc)+ log(popdens),
           data=dados,
           effect = "twoways",
           model = "within")
summary(jud)
...
judp <- plm(log(Índice) ~ log(despjud/pop) + educ + +log (L) + log(K) + log(IMPORT) + log(agua) + log(energiapc)+ log(popdens),
            data=dados,
            effect = "twoways",
            model = "within")
summary(judp)  
...
adm <- plm(log(Índice) ~ log(despadm) + educ + +log (L) + log(K) + log(IMPORT) + log(agua) + log(energiapc)+ log(popdens),
           data=dados,
           effect = "twoways",
           model = "within")
summary(adm)
...
admp <- plm(log(Índice) ~ log(despadm/pop) + educ + +log (L) + log(K) + log(IMPORT) + log(agua) + log(energiapc)+ log(popdens),
            data=dados,
            effect = "twoways",
            model = "within")
summary(admp)
...
educ <- plm(log(Índice) ~ log(despeduc) + educ + +log (L) + log(K) + log(IMPORT) + log(agua) + log(energiapc)+ log(popdens),
            data=dados,
            effect = "twoways",
            model = "within")
summary(educ)
...
educp <- plm(log(Índice) ~  log(despeduc/pop) + educ + +log (L) + log(K) + log(IMPORT) + log(agua) + log(energiapc)+ log(popdens),
             data=dados,
             effect = "twoways",
             model = "within")
summary(educp)
...
#despesa legislativa
leg <- plm(log(Índice) ~ log(despleg) + educ + +log (L) + log(K) + log(IMPORT) + log(agua) + log(energiapc)+ log(popdens),
           data=dados,
           effect = "twoways",
           model = "within")
summary(leg)

legp <- plm(log(Índice) ~  log(despleg/pop) + educ + +log (L) + log(K) + log(IMPORT) + log(agua) + log(energiapc)+ log(popdens),
            data=dados,
            effect = "twoways",
            model = "within")
...
ics <- plm(log(Índice) ~  log(despics) + educ + +log (L) + log(K) + log(IMPORT) + log(agua) + log(energiapc)+ log(popdens),
           data=dados,
           effect = "twoways",
           model = "within")
summary(ics)

icsp <- plm(log(Índice) ~  log(despics/pop) + educ + +log (L) + log(K) + log(IMPORT) + log(agua) + log(energiapc)+ log(popdens),
            data=dados,
            effect = "twoways",
            model = "within")
...
#tec
tec <- plm(log(Índice) ~  log(desptec) + educ + +log (L) + log(K) + log(IMPORT) + log(agua) + log(energiapc)+ log(popdens),
           data=dados,
           effect = "twoways",
           model = "within")
summary(tec)

tecp <- plm(log(Índice) ~  log(desptec/pop) + educ + +log (L) + log(K) + log(IMPORT) + log(agua) + log(energiapc)+ log(popdens),
            data=dados,
            effect = "twoways",
            model = "within")
...
#assistencia
assist <- plm(log(Índice) ~  log(despass) + educ + +log (L) + log(K) + log(IMPORT) + log(agua) + log(energiapc)+ log(popdens),
              data=dados,
              effect = "twoways",
              model = "within")
summary(assist)

assistp <- plm(log(Índice) ~  log(despass/pop) + educ + +log (L) + log(K) + log(IMPORT) + log(agua) + log(energiapc)+ log(popdens),
               data=dados,
               effect = "twoways",
               model = "within")
...
#saude
saude <- plm(log(Índice) ~  log(despjud) + educ + +log (L) + log(K) + log(IMPORT) + log(agua) + log(energiapc)+ log(popdens),
             data=dados,
             effect = "twoways",
             model = "within")
summary(saude)

saudep <- plm(log(Índice) ~  log(despjud) + educ + +log (L) + log(K) + log(IMPORT) + log(agua) + log(energiapc)+ log(popdens),
              data=dados,
              effect = "twoways",
              model = "within")
